...
<body>
            ...
            <div class="d-flex justify-content-between">
                <div class="top-info ps-2">
                    <small class="me-3"><i class="fas fa-map-marker-alt me-2 text-secondary"></i> <a href="#"
                            class="text-white">Street, Makutano</a></small>
                    <small class="me-3"><i class="fas fa-envelope me-2 text-secondary"></i><a href="#"
                            class="text-white">info@thecraneschool.sc.ke</a></small>
                </div>
        ...
        <div class="container px-0">
            <nav class="navbar navbar-light navbar-expand-xl py-3">
                <a href="{{ route('home') }}" class="navbar-brand">
                    <h1 class="text-primary display-6">the<span class="text-secondary">Crane</span>School</h1>
                </a>
                    ...
                    <div class="navbar-nav mx-auto">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                <a href="{{ route('blog.index') }}" class="dropdown-item">Our Blog</a>
                            </div>
                        </div>
                        <a href="{{ route('student.access') }}"
                            class="nav-item nav-link {{ request()->routeIs('student.access') ? 'active' : '' }}">Student
                            Access</a>
            ...
            <div class="row g-5">
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <div class="footer-item">
                        <h2 class="fw-bold mb-3"><span class="text-primary mb-0">the</span><span
                                class="text-secondary">Crane</span>Schhol</h2>
                ...
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <div class="footer-item">
                        ...
                        <div class="d-flex flex-column align-items-start">
                            <a href="" class="text-body mb-4"><i class="fa fa-map-marker-alt text-primary me-2"></i>
                                West Poko, Makutano</a>
                            <a href="" class="text-start rounded-0 text-body mb-4"><i
                                    class="fa fa-phone-alt text-primary me-2"></i> (+012) 3456 7890 123</a>
                            <a href="" class="text-start rounded-0 text-body mb-4"><i
                                    class="fas fa-envelope text-primary me-2"></i> info@thecranceschool.sc.ke</a>
                        ...
                        <div class="row g-3">
                            <div class="col-4">
                                <div class="footer-galary-img rounded-circle border border-primary">
                                    <img src="{{ asset("frontend/img/galary-1.jpg")}}" class="img-fluid rounded-circle p-2"
                                        alt="">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="footer-galary-img rounded-circle border border-primary">
                                    <img src="{{ asset("frontend/img/galary-2.jpg")}}" class="img-fluid rounded-circle p-2"
                                        alt="">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="footer-galary-img rounded-circle border border-primary">
                                    <img src="{{ asset("frontend/img/galary-3.jpg")}}" class="img-fluid rounded-circle p-2"
                                        alt="">
                                </div>
                            </div>
                            <div class="col-4">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 my-auto text-center text-md-end text-white">
                    Designed By <a class="border-bottom" href="https://toroyteach.com">Toroyteach</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="{{ asset("rontend/lib/waypoints/waypoints.min.js")}}f"></script>
